    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Agency')),
            ],
        ),
        migrations.CreateModel(
            name='FareRule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='route', to='jpbusformat.Route')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.Service')),
            ],
        ),
        migrations.CreateModel(
            name='Shape',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_station', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Stop')),
            ],
        ),
        migrations.CreateModel(
            name='StopTime',
            fields=[
                ...
                ('stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.Stop')),
            ],
        ),
        migrations.CreateModel(
            name='Transfer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Office')),
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.Route')),
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Service')),
                ('shape', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Shape')),
            ],
        ),
        migrations.CreateModel(
            name='Zone',
        ...
        migrations.AddField(
            model_name='stoptime',
            name='trip',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.Trip'),
        ),
        migrations.AddField(
            model_name='stop',
            name='zone',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jpbusformat.Zone'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='farerule',
            name='contains',
            field=models.ForeignKey(blank=True, help_text='通過ゾーン', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contains_zones', to='jpbusformat.Zone'),
        ),
        migrations.AddField(
            model_name='farerule',
            name='destination',
            field=models.ForeignKey(blank=True, help_text='降車地ゾーン', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='destination_zones', to='jpbusformat.Zone'),
        ),
        migrations.AddField(
            model_name='farerule',
            name='fare',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.FareAttribute'),
        ),
        migrations.AddField(
            model_name='farerule',
            name='origin',
            field=models.ForeignKey(blank=True, help_text='乗車地ゾーン', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='origin_zones', to='jpbusformat.Zone'),
        ),
        migrations.AddField(
            model_name='farerule',
            name='route',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jpbusformat.Route'),
        ),
    ]
