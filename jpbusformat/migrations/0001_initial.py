# Generated by Django 2.1.3 on 2018-11-28 03:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trans_id', models.CharField(help_text='翻訳元日本語', max_length=256)),
        ...
        migrations.AddField(
            ...
            name='trip',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='frequency', to='jpbusformat.Trip'),
        ),
        migrations.AddField(
            model_name='farerule',
            name='contains',
